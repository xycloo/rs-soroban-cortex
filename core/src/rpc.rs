...
use log::{error, info};
use crate::{SorobanEventsSteamConfig, utils::build_invoke_contract_tx, node::BridgeMessage};
...
#[async_trait]
pub trait SorobanBridgeHelperRpc {
...
#[async_trait]
impl<'a, I> SorobanBridgeHelperRpc for BridgeMessage<'a, I>
    where I: Send 
    {
