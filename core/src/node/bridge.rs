...
use crate::{
    ...
    messaging::{LockedInBridge, TryIntoMessage}, Node, NodeConfiguration, EventLogger
};

use super::{EventProcessor, BridgeMessageNode};
...
#[async_trait]
impl<'a, I: std::marker::Send> EventProcessor<I> for BridgeMessageNode<'a, I>
    where I: TryIntoMessage
...
impl <'a, I: Send> BridgeMessageNode<'a, I> 
    where I: TryIntoMessage 
